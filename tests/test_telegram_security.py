...
class TestTelegramSecurity(unittest.TestCase):
    ...
    @patch('components.telegram_manager.TelegramBridge')
    ...
    @patch('components.telegram_manager.TelegramManager.connect')
    @patch('components.telegram_manager.TelegramManager.disconnect')
    ...
    def test_handle_telegram_text_security(self, MockStyle, mock_disconnect, mock_connect, mock_clear, mock_docs, mock_db, mock_chat, mock_watcher, mock_redirect, mock_load_ui, mock_setup_ui, MockBridge, MockController, MockCore):
        ...
        app.telegram_manager.handle_disrupt_command = MagicMock()
        ...
        # Call on manager
        app.telegram_manager.handle_telegram_text(msg)
        ...
        app.telegram_manager.handle_telegram_text(authorized_msg)
    ...
    def test_other_handlers_security(self, MockStyle, mock_disconnect, mock_connect, mock_clear, mock_docs, mock_db, mock_chat, mock_watcher, mock_redirect, mock_load_ui, mock_setup_ui, MockBridge, MockController, MockCore):
        ...
        # Use manager's bridge
        app.telegram_manager.bridge = MagicMock()
        ...
        app.telegram_manager.handle_telegram_document(msg_doc)
        app.telegram_manager.bridge.get_file_info.assert_not_called()

        # Photo Handler
        msg_photo = {"photo": {"file_id": "123"}, "chat_id": unauthorized_chat_id}
        app.telegram_manager.handle_telegram_photo(msg_photo)
        app.telegram_manager.bridge.get_file_info.assert_not_called()

        # Voice Handler
        msg_voice = {"voice": {"file_id": "123"}, "chat_id": unauthorized_chat_id}
        app.telegram_manager.handle_telegram_voice(msg_voice)
        app.telegram_manager.bridge.get_file_info.assert_not_called()
